...
const EditCateNew = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(`https://bevclock-production.up.railway.app/api/admin/categoryNews/${id}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`https://bevclock-production.up.railway.app/api/admin/categoryNews/sua/${id}`, {
        method: 'PUT',
        headers: {
